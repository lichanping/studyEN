# Cline Global Coding Instructions

**Source:** `.github/copilot-instructions.md` — **TDD First Principle**
...
If a task cannot reasonably follow TDD (e.g., one-off scripts or purely mechanical edits):
- **State why** TDD is not applicable
- **Still add validation checks** when possible
