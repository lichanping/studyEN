...
export function handleScheduleNotificationClick() {
    ...
    if (timeDifference > 0 && timeDifference <= 30) {
        notificationMessage = `【新课提醒-${thisDateTime}】<br><br>⏰我们的在线课程还有 **${timeDifference}** 分钟开始了，请做好准备，及时进入会议室哦🔥`;
    } else {
        notificationMessage = `【新课提醒-${thisDateTime}】<br><br>亲爱的 ⭐ ${userName} 用户您好! 我们的英语《${courseLabel}》学习时间安排在${formattedDateTime}。<br><br>⏰请学员及家长准时进入会议室上课，并确保摄像头🎥开启。感谢您的配合！`;
    }
