...
6. index.html（正式课入口页）
- 增加平台选择控件。
- 当平台为“百分缔”时，支持上传单词表图片并自动提取文本到“新学单词（英文+中文）”输入区，减少手动录入。
...
- 正式课课堂反馈提交时：
  - 李校来啦平台维持原有“按已填写新学单词内容核对词数”的行为。
  - 百分缔平台在“新学单词（英文+中文）”非空时，按提取/粘贴后的英文词数与手填新学词数进行比对，并允许一键替换。
  - 百分缔平台在“新学单词（英文+中文）”为空时，跳过词数比对，保留原先手动输入方式。
  - 麦穗英语维持手动输入，不受本次规则影响。
...
9. AC-09：在 `index.html` 切换到“百分缔”后，支持上传单词表图片并自动回填到“新学单词（英文+中文）”输入区。
10. AC-10：在 `index.html` 切换到“百分缔”后，仅当“新学单词（英文+中文）”非空时才核对词数；为空时跳过核对。
11. AC-11：李校来啦平台的“新学单词词数核对”原有行为不变。
