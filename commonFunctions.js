...
export function handleGroupGreetingClick() {
    ...
    const greetingMessage = currentPlatformId === "baifendii"
        ? `${userName}同学家长您好!<br><br>我是${teacherName}:将担任孩子的英语学习教练，负责孩子在百分缔英语学习、复习过程的引导、陪伴、监督与指导，我会及时在群内发送学员学习报告，请您关注！<br><br>我会提前将课程发送到群里，麻烦提前下载好腾讯会议，电脑、笔记本、平板、手机都可使用(台式电脑必须佩戴耳机)，请提前安排好时间。<br><br>这是我的个人介绍，期望接下来一起帮助孩子英语学习进步!`
