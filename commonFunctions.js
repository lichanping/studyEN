...
export function handleManagementGroupTemplateClick() {
    ...
    if (timeDifference > 0 && timeDifference <= 30) {
        ...
        outputMessage = `【抗遗忘温馨提醒-${hour}:${minute}】<br><br>👍 ${(window.APP_MEETING_CONFIG?.getCurrentTencentMeetingTag?.() || window.APP_MEETING_CONFIG.tencentMeetingTag)}<br><br>⏰ 请准时参加会议，如有特殊情况无法参加，请提前告知！<br><br>🔔 若未按约定时间参加复习，请自主复习并打卡至学习群📱<br><br>🔒 仅在当天有收到提醒通知才需入会。<br><br>📢 请在抗遗忘时及时反馈是否需要取消下次安排的正课，以便妥善安排教学计划，老师为你骄傲🌹`;
    }
...
export function selfReviewClick() {
    const feedbackMessage = `📚 课后复习安排<br><br>1. 今日笔头作业（必做）：打印【每日单词表】，看中文版写英文，看英文版写中文；对照批改后拍照发群打卡。建议每天练1遍，落实会拼会写。<br><br>2. 今日口头作业：新学单词大声朗读2遍，录音或视频发群打卡。<br><br>❗ 两项作业都要完成<br>⏰ 截止：今晚22:20前<br><br>📌 复习规则：坚持21天抗遗忘复习，做到看到英文会读、知道中文；当天遗忘的单词及时加入生词本巩固。<br><br>☀️ 继续加油，坚持会更有收获。`
